        ...
        <>
            ...
            <div className="wrap">
                <div className="left-p">
                    ...
                    <div className="stats">
                        <div className="stat"><div className="stat-n">12.4k</div><div className="stat-l">Usuarios</div></div>
                        <div className="stat"><div className="stat-n">3.8t</div><div className="stat-l">Reciclado</div></div>
                        <div className="stat"><div className="stat-n">847</div><div className="stat-l">Puntos</div></div>
                    </div>
                </div>

                <div className="right-p">
                    <div className="fh" style={{ marginBottom:'2rem' }}>
                        <div className="pts-badge">⭐ Gana 50 puntos al iniciar sesión hoy</div>
                    ...
                    <form onSubmit={submit}>
                        ...
                        <div className="divider"><div className="dvl"/><span className="dvt">o continúa con</span><div className="dvl"/></div>
                        <button type="button" className="btn-g">
